...
<head>
  ...
  <meta content="registersucessful" property="og:title">
  ...
  <meta content="registersucessful" property="twitter:title">
  ...
  <div class="page-wrapper">
    ...
    <div class="section no-padding-vertical">
      ...
      <div class="w-layout-blockcontainer container-30 w-container">
        <h1 class="heading-29">註冊成功！歡迎加入 5TEAM</h1>
        <div class="text-block-21">請按下方按鈕立即登入</div>
        <a href="<c:url value='/login'/>" class="button-83 w-button">登入</a>
      </div>
    </div>
  </div>
  <section class="footer-light-01">
    <div class="container">
      <div class="footer-wrapper-two">
        ...
        <div class="footer-form w-form">
          <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64f3ecb9ab86dd89fd25a270" data-wf-element-id="f441a17e-0218-ad41-4792-bb1474696d31">
