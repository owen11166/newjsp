...
<html data-wf-page="64f3ecb9ab86dd89fd25a264" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>model2</title>
   	<style>
	...
	document.addEventListener("DOMContentLoaded", function() {
	    ...
	    submitButton.addEventListener('click', function(e) {
	        ...
	        if (password !== passwordConfirm) {
	            e.preventDefault();
	            passwordConfirmError.textContent = '密碼和確認密碼不一致！';
	        } else {
  ...
  <meta content="model2" property="og:title">
  ...
  <meta content="model2" property="twitter:title">
...
<body>
  ...
  <div class="page-wrapper">
        ...
        <div class="wrapper nav-bar-wrapper">
          ...
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
              ...
              <a href="../index.html" class="nav-link w-nav-link">社區</a>
    ...
    <div class="f-section-large-2-co28py">
      <div class="w-layout-blockcontainer container-29 w-container">
        <h1 class="heading-27-copy">立即註冊</h1>
        <div class="f-container-x-small">
          <div class="f-margin-bottom-56">
            <div class="f-title-wrapper-left"></div>
          </div>
          <div class="w-form">
				    <form:form action="/save" method="post" class="f-contact-form-2" modelAttribute="user">
	        <div class="w-layout-grid f-contact-form-grid">
	            <div>
	                <label for="username" class="f-field-label-3">使用者名稱</label>
	                <form:input type="text" class="f-field-input-3 w-input"  name="username" id="username" path="username" placeholder="使用者名稱 (至少 3 個字元)"/>
					<form:errors path="username" cssClass="error"/>
	            </div>
	            <div>
	                <label for="email" class="f-field-label-3">電子郵件</label>
	                <form:input type="text" class="f-field-input-3 w-input"  name="email" id="email" path="email"  placeholder="請填寫Email"/>
	                <form:errors  path="email" cssClass="error"   />
	            </div>
	            <div>
	                <label for="password" class="f-field-label-3">密碼</label>
	                <form:input type="password" class="f-field-input-3 w-input" name="password" id="password" placeholder="請設定6-15位密碼" path="password"/>
	                <form:errors  path="password" cssClass="error" />
	            </div>
	            <div>
	                <label for="passwordConfirm" class="f-field-label-3">密碼確認</label>
	                <input type="password" class="f-field-input-3 w-input" maxlength="256" name="passwordConfirm" id="passwordConfirm" placeholder="請再輸入一次密碼">
	                <span class="error" id="passwordConfirmError"></span>
	            </div>
	        </div>
	        <div class="f-contact-submit-wrapper">
	             <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
	            <input type="submit" value="註冊" data-wait="Please wait..." class="f-button-neutral-3 w-button">
      ...
      <section class="section-12316">
        <div class="w-layout-blockcontainer container-2288-copy w-container">
          <p class="paragraph-11">已經擁有5TEAM帳號嗎?</p>
          <a href="<c:url value='/login'/>" class="button-79 w-button">按此登入</a>
        </div>
      </section>
    </div>
    ...
    <section class="footer-light-05185-copy">
      <div class="container">
        <div class="footer-wrapper-two">
          <a href="#" class="footer-brand-2 w-inline-block"><img src="../images/LOGO.png" loading="lazy" width="253" sizes="(max-width: 479px) 88vw, 253px" alt="" srcset="../images/LOGO-p-500.png 500w, ../images/LOGO.png 556w"></a>
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64f3ecb9ab86dd89fd25a264" data-wf-element-id="d7c60714-2eee-98b4-1588-3891527f5329">
